...
const BUSINESS_TYPES = [
  {
    ...
    roleLabels: {},
    roleScreenAccess: { owner: ['backoffice', 'pos', 'client_orders'], manager: ['backoffice_restricted', 'expenses', 'client_orders'], commercial: ['pos', 'losses', 'transfers', 'stock_view', 'daily_sales', 'client_orders'], cashier: ['pos', 'client_orders'] },
    icon: 'store',
    vertical: 'retail',
  },
  {
    ...
    visibleSections: ['expiry', 'transfers'] as string[],
    suggestedCategories: ['Fruits & Légumes', 'Épices', 'Céréales', 'Boissons', 'Produits laitiers', 'Conserves'] as string[],
    documentType: 'receipt',
    roleLabels: {},
    roleScreenAccess: { owner: ['backoffice', 'client_orders'], manager: ['backoffice_restricted', 'expenses', 'client_orders'], commercial: ['pos', 'losses', 'transfers', 'stock_view', 'daily_sales', 'client_orders'], cashier: ['pos', 'client_orders'] },
    transferLabels: { sendAction: 'Envoi magasin → rayon', sendButton: 'Envoyer au rayon', confirmAction: 'Confirmation rayon', confirmButton: "J'ai bien reçu", fromLabel: 'Magasin', toLabel: 'Rayon' },
  ...
  },
  {
    ...
    roleScreenAccess: { owner: ['backoffice', 'pos', 'client_orders'], manager: ['backoffice_restricted', 'client_orders'], commercial: ['pos', 'stock_view', 'daily_sales', 'client_orders'], cashier: ['pos'] },
    icon: 'phone_android',
    vertical: 'retail',
  },
  {
    ...
    documentType: 'receipt',
    roleLabels: {},
    roleScreenAccess: { owner: ['backoffice', 'pos', 'client_orders'], manager: ['backoffice_restricted', 'stock_view', 'client_orders'], commercial: ['pos', 'stock_view', 'daily_sales', 'client_orders'], cashier: ['pos'] },
    icon: 'checkroom',
    vertical: 'retail',
  },
  {
    ...
    roleScreenAccess: { owner: ['backoffice', 'pos', 'client_orders'], manager: ['backoffice_restricted', 'clients_view', 'client_orders'], commercial: ['pos', 'stock_view', 'daily_sales', 'client_orders'], cashier: ['pos'] },
    icon: 'local_pharmacy',
    vertical: 'retail',
  },
  {
    ...
    roleLabels: {},
    roleScreenAccess: { owner: ['backoffice', 'pos', 'client_orders'], manager: ['backoffice_restricted', 'stock_view', 'expenses', 'client_orders'], commercial: ['pos', 'losses', 'stock_view', 'daily_sales', 'client_orders'], cashier: ['pos'] },
    icon: 'hardware',
    vertical: 'retail',
  },
  {
    ...
    roleScreenAccess: { owner: ['backoffice', 'pos', 'client_orders'], manager: ['backoffice_restricted', 'client_orders'], commercial: ['pos', 'daily_sales', 'client_orders'], cashier: ['pos'] },
    icon: 'kitchen',
    vertical: 'retail',
  },
  {
  ...
  },
  {
    ...
    documentType: 'receipt',
    roleLabels: {},
    roleScreenAccess: { owner: ['backoffice', 'pos', 'client_orders'], manager: ['backoffice_restricted', 'expenses', 'client_orders'], commercial: ['pos', 'losses', 'daily_sales', 'client_orders'], cashier: ['pos', 'client_orders'] },
    icon: 'bakery_dining',
    vertical: 'retail',
  },
  {
    ...
    visibleSections: ['weight', 'transfers'] as string[],
    ...
    roleScreenAccess: { owner: ['backoffice', 'client_orders'], manager: ['backoffice_restricted', 'stock_view', 'expenses', 'client_orders'], commercial: ['pos', 'transfers', 'stock_view', 'daily_sales', 'client_orders'], cashier: ['pos'] },
    transferLabels: { sendAction: 'Approvisionnement pompe', sendButton: 'Approvisionner', confirmAction: 'Confirmation pompe', confirmButton: 'Pompe approvisionnée', fromLabel: 'Citerne', toLabel: 'Pompe' },
  ...
  },
  {
    ...
    defaultFlags: { hasVariants: true, unitType: 'weight' },
    visibleSections: ['variants', 'weight', 'transfers'] as string[],
  ...
  },
  {
    ...
    defaultFlags: { hasVariants: true },
    visibleSections: ['variants', 'transfers'] as string[],
  ...
  },
  {
    ...
    visibleSections: ['expiry', 'freshness', 'transfers'] as string[],
    ...
    roleScreenAccess: { owner: ['backoffice', 'pos', 'client_orders'], manager: ['backoffice_restricted', 'expenses', 'client_orders'], commercial: ['pos', 'losses', 'transfers', 'daily_sales'], cashier: ['pos'] },
    transferLabels: { sendAction: 'Envoi cuisine → comptoir', sendButton: 'Envoyer au comptoir', confirmAction: 'Confirmation comptoir', confirmButton: 'Reçu au comptoir', fromLabel: 'Cuisine', toLabel: 'Comptoir' },
    icon: 'restaurant',
    vertical: 'retail',
  },
];
...
async function seedBusinessTypes() {
  ...
  for (const bt of BUSINESS_TYPES) {
    const data = {
      ...
      transferLabels: (bt as any).transferLabels ?? {},
      icon: bt.icon,
