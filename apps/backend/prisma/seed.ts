...
const BUSINESS_TYPES = [
  {
    ...
    roleLabels: {},
    roleScreenAccess: { owner: ['backoffice', 'pos', 'client_orders'], manager: ['backoffice_restricted', 'expenses', 'client_orders'], commercial: ['pos', 'losses', 'transfers', 'stock_view', 'daily_sales', 'client_orders'], cashier: ['pos'] },
    icon: 'store',
    vertical: 'retail',
  },
  {
    ...
    documentType: 'receipt',
    roleLabels: {},
    roleScreenAccess: { owner: ['backoffice', 'client_orders'], manager: ['backoffice_restricted', 'expenses', 'client_orders'], commercial: ['pos', 'losses', 'transfers', 'stock_view', 'daily_sales', 'client_orders'], cashier: ['pos'] },
  ...
  },
  {
    ...
    documentType: 'receipt',
    roleLabels: {},
    roleScreenAccess: { owner: ['backoffice', 'pos', 'client_orders'], manager: ['backoffice_restricted', 'expenses', 'client_orders'], commercial: ['pos', 'losses', 'daily_sales', 'client_orders'], cashier: ['pos'] },
    icon: 'bakery_dining',
    vertical: 'retail',
  },
  {
