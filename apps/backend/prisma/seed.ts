...
const BUSINESS_TYPES = [
  ...
  },
  {
    ...
    roleScreenAccess: { owner: ['backoffice'], manager: ['backoffice_restricted', 'stock_view', 'expenses'], commercial: ['pos', 'transfers', 'stock_view', 'daily_sales'], cashier: ['pos'] },
  ...
  },
  {
    ...
    roleScreenAccess: { owner: ['backoffice'], manager: ['backoffice_restricted', 'clients_view', 'expenses'], commercial: ['pos', 'client_orders', 'transfers', 'stock_view', 'daily_sales'], cashier: ['pos'] },
  ...
  },
  {
    ...
    roleScreenAccess: { owner: ['backoffice'], manager: ['backoffice_restricted', 'stock_view', 'expenses'], commercial: ['pos', 'client_orders', 'transfers', 'deliveries', 'stock_view', 'daily_sales'], cashier: ['pos'] },
  ...
  },
  {
    ...
    roleScreenAccess: { owner: ['backoffice', 'pos'], manager: ['backoffice_restricted', 'expenses'], commercial: ['pos', 'losses', 'transfers', 'daily_sales'], cashier: ['pos'] },
