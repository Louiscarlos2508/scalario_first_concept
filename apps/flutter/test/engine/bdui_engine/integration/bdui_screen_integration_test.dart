...
import 'package:scalario/engine/canvas/bdui_screen.dart';
...
ScalarioCanvas _engineFor(Map<String, Map<String, dynamic>> screens, _Provider p) {
...
Future<void> _pumpScreen(WidgetTester tester, ScalarioCanvas engine, String id) async {
...
void main() {
  testWidgets('retail_dashboard.json renders KPIs + alert + FAB',
    ...
    final ScalarioCanvas engine = _engineFor(
