...
import 'package:frontend/features/retail/inventory/presentation/widgets/stock_adjustment_dialog.dart';
...
class CatalogScreen extends ConsumerWidget {
  ...
  void _showMenu(BuildContext context, WidgetRef ref, Map<String, dynamic> item) {
  ...
  Future<void> _doDelete(
    ...
    try {
      await ref.read(catalogRepositoryProvider).deleteItem(
            id: id,
            tenantId: tenantId,
          );
  ...
  Widget build(BuildContext context) {
    ...
    return Dismissible(
      ...
      child: Card(
        ...
        child: ListTile(
          contentPadding:
              const EdgeInsets.only(left: 20, right: 4, top: 4, bottom: 4),
          onTap: onTap,
          ...
          subtitle:
              Text(_fcfa.format(price), style: AppTextStyles.bodySmall),
          trailing: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              // Stock badge
