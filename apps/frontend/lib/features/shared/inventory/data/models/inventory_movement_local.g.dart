...
part of 'inventory_movement_local.dart';
...
extension GetInventoryMovementLocalCollection on Isar {
  IsarCollection<InventoryMovementLocal> get inventoryMovementLocals =>
      this.collection();
}

const InventoryMovementLocalSchema = CollectionSchema(
  name: r'InventoryMovementLocal',
  id: 4103498575535472523,
  properties: {
  ...
  estimateSize: _inventoryMovementLocalEstimateSize,
  serialize: _inventoryMovementLocalSerialize,
  deserialize: _inventoryMovementLocalDeserialize,
  deserializeProp: _inventoryMovementLocalDeserializeProp,
  idName: r'id',
  indexes: {
    r'type': IndexSchema(
  ...
  links: {},
  embeddedSchemas: {},
  getId: _inventoryMovementLocalGetId,
  getLinks: _inventoryMovementLocalGetLinks,
  attach: _inventoryMovementLocalAttach,
  version: '3.1.0+1',
);

int _inventoryMovementLocalEstimateSize(
  InventoryMovementLocal object,
  List<int> offsets,
...
void _inventoryMovementLocalSerialize(
  InventoryMovementLocal object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
InventoryMovementLocal _inventoryMovementLocalDeserialize(
  ...
  final object = InventoryMovementLocal();
...
P _inventoryMovementLocalDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _inventoryMovementLocalGetId(InventoryMovementLocal object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _inventoryMovementLocalGetLinks(
    InventoryMovementLocal object) {
  return [];
}

void _inventoryMovementLocalAttach(
    IsarCollection<dynamic> col, Id id, InventoryMovementLocal object) {
  object.id = id;
}

extension InventoryMovementLocalQueryWhereSort
    on QueryBuilder<InventoryMovementLocal, InventoryMovementLocal, QWhere> {
  QueryBuilder<InventoryMovementLocal, InventoryMovementLocal, QAfterWhere>
      anyId() {
...
extension InventoryMovementLocalQueryWhere on QueryBuilder<
    InventoryMovementLocal, InventoryMovementLocal, QWhereClause> {
  ...
  QueryBuilder<InventoryMovementLocal, InventoryMovementLocal,
      QAfterWhereClause> syncStatusEqualTo(String syncStatus) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<InventoryMovementLocal, InventoryMovementLocal,
      QAfterWhereClause> syncStatusNotEqualTo(String syncStatus) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
...
extension InventoryMovementLocalQueryFilter on QueryBuilder<
    InventoryMovementLocal, InventoryMovementLocal, QFilterCondition> {
  QueryBuilder<InventoryMovementLocal, InventoryMovementLocal,
...
extension InventoryMovementLocalQueryObject on QueryBuilder<
    InventoryMovementLocal, InventoryMovementLocal, QFilterCondition> {}

extension InventoryMovementLocalQueryLinks on QueryBuilder<
    InventoryMovementLocal, InventoryMovementLocal, QFilterCondition> {}

extension InventoryMovementLocalQuerySortBy
    on QueryBuilder<InventoryMovementLocal, InventoryMovementLocal, QSortBy> {
...
extension InventoryMovementLocalQuerySortThenBy on QueryBuilder<
    InventoryMovementLocal, InventoryMovementLocal, QSortThenBy> {
  QueryBuilder<InventoryMovementLocal, InventoryMovementLocal, QAfterSortBy>
      thenByCatalogItemId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'catalogItemId', Sort.asc);
...
extension InventoryMovementLocalQueryWhereDistinct
    on QueryBuilder<InventoryMovementLocal, InventoryMovementLocal, QDistinct> {
...
extension InventoryMovementLocalQueryProperty on QueryBuilder<
    InventoryMovementLocal, InventoryMovementLocal, QQueryProperty> {
  QueryBuilder<InventoryMovementLocal, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<InventoryMovementLocal, DateTime, QQueryOperations>
      createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<InventoryMovementLocal, int, QQueryOperations>
      quantityProperty() {
    return QueryBuilder.apply(this, (query) {
