...
class InventoryRepository {
  ...
  Future<List<Map<String, dynamic>>> getPendingTransfers({
    ...
    ).replace(queryParameters: {'tenantId': tenantId, 'type': 'TRANSFER_OUT'});
  ...
  Future<int> getStock({
    ...
    final uri = Uri.parse('${ApiConstants.baseUrl}/inventory/stock').replace(
      queryParameters: {'catalogItemId': catalogItemId, 'tenantId': tenantId},
    );
